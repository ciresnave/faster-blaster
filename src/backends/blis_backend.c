...
static void blis_sgemv(const fb_layout_t layout, const fb_transpose_t trans, const int64_t m, const int64_t n, const float alpha,
                      const float* a, const int64_t lda, const float* x, const int64_t incx,
                      const float beta, float* y, const int64_t incy) {
    /* Convert layout + lda to BLIS row/column strides */
    inc_t rsa, csa;
    if (layout == FB_LAYOUT_ROW_MAJOR) {
        rsa = (inc_t)lda;  /* row stride = lda (columns per row) */
        csa = 1;            /* column stride = 1 (consecutive) */
    } else {
        rsa = 1;            /* row stride = 1 (consecutive) */
        csa = (inc_t)lda;   /* column stride = lda (rows per column) */
    }
    ...
    /* Try expert interface first (faster, supports threading control) */
    if (g_blis.sgemv_ex) {
        g_blis.sgemv_ex(blis_trans, BLIS_NO_CONJUGATE,
                        (dim_t)m, (dim_t)n, &alpha_val, a, rsa, csa,
                        x, (inc_t)incx, &beta_val, y, (inc_t)incy,
                        NULL, NULL);  /* NULL context/runtime = use defaults */
    }
    /* Fallback to basic interface (AOCL-BLIS may not export _ex variants) */
...
static void blis_dgemv(const fb_layout_t layout, const fb_transpose_t trans, const int64_t m, const int64_t n, const double alpha,
...
static void blis_sgemm(const fb_layout_t layout, const fb_transpose_t transa, const fb_transpose_t transb, const int64_t m, const int64_t n, const int64_t k,
...
static void blis_dgemm(const fb_layout_t layout, const fb_transpose_t transa, const fb_transpose_t transb, const int64_t m, const int64_t n, const int64_t k,
...
static void blis_cgemv(char trans, int m, int n, const fb_complex_float_t* alpha, const fb_complex_float_t* a, int lda,
...
static void blis_zgemv(char trans, int m, int n, const fb_complex_double_t* alpha, const fb_complex_double_t* a, int lda,
...
static void blis_sgbmv(char trans, int m, int n, int kl, int ku, float alpha, const float* a, int lda,
...
static void blis_dgbmv(char trans, int m, int n, int kl, int ku, double alpha, const double* a, int lda,
...
static void blis_cgbmv(char trans, int m, int n, int kl, int ku, const fb_complex_float_t* alpha, const fb_complex_float_t* a, int lda,
                      const fb_complex_float_t* x, int incx, const fb_complex_float_t* beta, fb_complex_float_t* y, int incy) {
...
static void blis_zgbmv(char trans, int m, int n, int kl, int ku, const fb_complex_double_t* alpha, const fb_complex_double_t* a, int lda,
                      const fb_complex_double_t* x, int incx, const fb_complex_double_t* beta, fb_complex_double_t* y, int incy) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_TRANSPOSE, int, int, int, int, const void*, const void*, int, const void*, int, const void*, void*, int);
...
static void blis_chemv(char uplo, int n, const fb_complex_float_t* alpha, const fb_complex_float_t* a, int lda,
                      const fb_complex_float_t* x, int incx, const fb_complex_float_t* beta, fb_complex_float_t* y, int incy) {
...
static void blis_zhemv(char uplo, int n, const fb_complex_double_t* alpha, const fb_complex_double_t* a, int lda,
                      const fb_complex_double_t* x, int incx, const fb_complex_double_t* beta, fb_complex_double_t* y, int incy) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, int, const void*, const void*, int, const void*, int, const void*, void*, int);
...
static void blis_chbmv(char uplo, int n, int k, const fb_complex_float_t* alpha, const fb_complex_float_t* a, int lda,
                      const fb_complex_float_t* x, int incx, const fb_complex_float_t* beta, fb_complex_float_t* y, int incy) {
...
static void blis_zhbmv(char uplo, int n, int k, const fb_complex_double_t* alpha, const fb_complex_double_t* a, int lda,
                      const fb_complex_double_t* x, int incx, const fb_complex_double_t* beta, fb_complex_double_t* y, int incy) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, int, int, const void*, const void*, int, const void*, int, const void*, void*, int);
...
static void blis_chpmv(char uplo, int n, const fb_complex_float_t* alpha, const fb_complex_float_t* ap,
                      const fb_complex_float_t* x, int incx, const fb_complex_float_t* beta, fb_complex_float_t* y, int incy) {
...
static void blis_zhpmv(char uplo, int n, const fb_complex_double_t* alpha, const fb_complex_double_t* ap,
                      const fb_complex_double_t* x, int incx, const fb_complex_double_t* beta, fb_complex_double_t* y, int incy) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, int, const void*, const void*, const void*, int, const void*, void*, int);
...
static void blis_ssymv(char uplo, int n, float alpha, const float* a, int lda,
                      const float* x, int incx, float beta, float* y, int incy) {
...
static void blis_dsymv(char uplo, int n, double alpha, const double* a, int lda,
                      const double* x, int incx, double beta, double* y, int incy) {
...
static void blis_csymv(char uplo, int n, const fb_complex_float_t* alpha, const fb_complex_float_t* a, int lda,
                      const fb_complex_float_t* x, int incx, const fb_complex_float_t* beta, fb_complex_float_t* y, int incy) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, int, const void*, const void*, int, const void*, int, const void*, void*, int);
...
static void blis_zsymv(char uplo, int n, const fb_complex_double_t* alpha, const fb_complex_double_t* a, int lda,
                      const fb_complex_double_t* x, int incx, const fb_complex_double_t* beta, fb_complex_double_t* y, int incy) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, int, const void*, const void*, int, const void*, int, const void*, void*, int);
...
static void blis_ssbmv(char uplo, int n, int k, float alpha, const float* a, int lda,
                      const float* x, int incx, float beta, float* y, int incy) {
...
static void blis_dsbmv(char uplo, int n, int k, double alpha, const double* a, int lda,
                      const double* x, int incx, double beta, double* y, int incy) {
...
static void blis_sspmv(char uplo, int n, float alpha, const float* ap,
                      const float* x, int incx, float beta, float* y, int incy) {
...
static void blis_dspmv(char uplo, int n, double alpha, const double* ap,
                      const double* x, int incx, double beta, double* y, int incy) {
...
static void blis_strmv(char uplo, char trans, char diag, int n, const float* a, int lda, float* x, int incx) {
...
static void blis_dtrmv(char uplo, char trans, char diag, int n, const double* a, int lda, double* x, int incx) {
...
static void blis_ctrmv(char uplo, char trans, char diag, int n, const fb_complex_float_t* a, int lda, fb_complex_float_t* x, int incx) {
...
static void blis_ztrmv(char uplo, char trans, char diag, int n, const fb_complex_double_t* a, int lda, fb_complex_double_t* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, const void*, int, void*, int);
...
static void blis_stbmv(char uplo, char trans, char diag, int n, int k, const float* a, int lda, float* x, int incx) {
...
static void blis_dtbmv(char uplo, char trans, char diag, int n, int k, const double* a, int lda, double* x, int incx) {
...
static void blis_ctbmv(char uplo, char trans, char diag, int n, int k, const fb_complex_float_t* a, int lda, fb_complex_float_t* x, int incx) {
...
static void blis_ztbmv(char uplo, char trans, char diag, int n, int k, const fb_complex_double_t* a, int lda, fb_complex_double_t* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, int, const void*, int, void*, int);
...
static void blis_stpmv(char uplo, char trans, char diag, int n, const float* ap, float* x, int incx) {
...
static void blis_dtpmv(char uplo, char trans, char diag, int n, const double* ap, double* x, int incx) {
...
static void blis_ctpmv(char uplo, char trans, char diag, int n, const fb_complex_float_t* ap, fb_complex_float_t* x, int incx) {
...
static void blis_ztpmv(char uplo, char trans, char diag, int n, const fb_complex_double_t* ap, fb_complex_double_t* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, const void*, void*, int);
...
static void blis_strsv(char uplo, char trans, char diag, int n, const float* a, int lda, float* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, const float*, int, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "cblas_strsv");
    if (fn) { fn(CblasColMajor, uplo_to_cblas(uplo), transpose_to_cblas(trans), diag_to_cblas(diag), n, a, lda, x, incx); }
}

static void blis_dtrsv(char uplo, char trans, char diag, int n, const double* a, int lda, double* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, const double*, int, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "cblas_dtrsv");
    if (fn) { fn(CblasColMajor, uplo_to_cblas(uplo), transpose_to_cblas(trans), diag_to_cblas(diag), n, a, lda, x, incx); }
}

static void blis_ctrsv(char uplo, char trans, char diag, int n, const fb_complex_float_t* a, int lda, fb_complex_float_t* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, const void*, int, void*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "cblas_ctrsv");
    if (fn) { fn(CblasColMajor, uplo_to_cblas(uplo), transpose_to_cblas(trans), diag_to_cblas(diag), n, a, lda, x, incx); }
}

static void blis_ztrsv(char uplo, char trans, char diag, int n, const fb_complex_double_t* a, int lda, fb_complex_double_t* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, const void*, int, void*, int);
...
static void blis_stbsv(char uplo, char trans, char diag, int n, int k, const float* a, int lda, float* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, int, const float*, int, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "cblas_stbsv");
    if (fn) { fn(CblasColMajor, uplo_to_cblas(uplo), transpose_to_cblas(trans), diag_to_cblas(diag), n, k, a, lda, x, incx); }
}

static void blis_dtbsv(char uplo, char trans, char diag, int n, int k, const double* a, int lda, double* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, int, const double*, int, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "cblas_dtbsv");
    if (fn) { fn(CblasColMajor, uplo_to_cblas(uplo), transpose_to_cblas(trans), diag_to_cblas(diag), n, k, a, lda, x, incx); }
}

static void blis_ctbsv(char uplo, char trans, char diag, int n, int k, const fb_complex_float_t* a, int lda, fb_complex_float_t* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, int, const void*, int, void*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "cblas_ctbsv");
    if (fn) { fn(CblasColMajor, uplo_to_cblas(uplo), transpose_to_cblas(trans), diag_to_cblas(diag), n, k, a, lda, x, incx); }
}

static void blis_ztbsv(char uplo, char trans, char diag, int n, int k, const fb_complex_double_t* a, int lda, fb_complex_double_t* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, int, const void*, int, void*, int);
...
static void blis_stpsv(char uplo, char trans, char diag, int n, const float* ap, float* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, const float*, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "cblas_stpsv");
    if (fn) { fn(CblasColMajor, uplo_to_cblas(uplo), transpose_to_cblas(trans), diag_to_cblas(diag), n, ap, x, incx); }
}

static void blis_dtpsv(char uplo, char trans, char diag, int n, const double* ap, double* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, const double*, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "cblas_dtpsv");
    if (fn) { fn(CblasColMajor, uplo_to_cblas(uplo), transpose_to_cblas(trans), diag_to_cblas(diag), n, ap, x, incx); }
}

static void blis_ctpsv(char uplo, char trans, char diag, int n, const fb_complex_float_t* ap, fb_complex_float_t* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, const void*, void*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "cblas_ctpsv");
    if (fn) { fn(CblasColMajor, uplo_to_cblas(uplo), transpose_to_cblas(trans), diag_to_cblas(diag), n, ap, x, incx); }
}

static void blis_ztpsv(char uplo, char trans, char diag, int n, const fb_complex_double_t* ap, fb_complex_double_t* x, int incx) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, const void*, void*, int);
...
static void blis_sger(int m, int n, float alpha, const float* x, int incx, const float* y, int incy, float* a, int lda) {
...
static void blis_dger(int m, int n, double alpha, const double* x, int incx, const double* y, int incy, double* a, int lda) {
...
static void blis_cher(char uplo, int n, float alpha, const fb_complex_float_t* x, int incx, fb_complex_float_t* a, int lda) {
...
static void blis_zher(char uplo, int n, double alpha, const fb_complex_double_t* x, int incx, fb_complex_double_t* a, int lda) {
...
static void blis_chpr(char uplo, int n, float alpha, const fb_complex_float_t* x, int incx, fb_complex_float_t* ap) {
...
static void blis_zhpr(char uplo, int n, double alpha, const fb_complex_double_t* x, int incx, fb_complex_double_t* ap) {
...
static void blis_cher2(char uplo, int n, const fb_complex_float_t* alpha, const fb_complex_float_t* x, int incx,
                      const fb_complex_float_t* y, int incy, fb_complex_float_t* a, int lda) {
...
static void blis_zher2(char uplo, int n, const fb_complex_double_t* alpha, const fb_complex_double_t* x, int incx,
                      const fb_complex_double_t* y, int incy, fb_complex_double_t* a, int lda) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, int, const void*, const void*, int, const void*, int, void*, int);
...
static void blis_chpr2(char uplo, int n, const fb_complex_float_t* alpha, const fb_complex_float_t* x, int incx,
...
static void blis_zhpr2(char uplo, int n, const fb_complex_double_t* alpha, const fb_complex_double_t* x, int incx,
...
static void blis_ssyr(char uplo, int n, float alpha, const float* x, int incx, float* a, int lda) {
...
static void blis_dsyr(char uplo, int n, double alpha, const double* x, int incx, double* a, int lda) {
...
static void blis_csyr(char uplo, int n, const fb_complex_float_t* alpha, const fb_complex_float_t* x, int incx, fb_complex_float_t* a, int lda) {
...
static void blis_zsyr(char uplo, int n, const fb_complex_double_t* alpha, const fb_complex_double_t* x, int incx, fb_complex_double_t* a, int lda) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, int, const void*, const void*, int, void*, int);
...
static void blis_sspr(char uplo, int n, float alpha, const float* x, int incx, float* ap) {
...
static void blis_dspr(char uplo, int n, double alpha, const double* x, int incx, double* ap) {
...
static void blis_ssyr2(char uplo, int n, float alpha, const float* x, int incx, const float* y, int incy, float* a, int lda) {
...
static void blis_dsyr2(char uplo, int n, double alpha, const double* x, int incx, const double* y, int incy, double* a, int lda) {
...
static void blis_sspr2(char uplo, int n, float alpha, const float* x, int incx, const float* y, int incy, float* ap) {
...
static void blis_dspr2(char uplo, int n, double alpha, const double* x, int incx, const double* y, int incy, double* ap) {
...
static void blis_cgemm(char transa, char transb, int m, int n, int k, const fb_complex_float_t* alpha,
...
static void blis_zgemm(char transa, char transb, int m, int n, int k, const fb_complex_double_t* alpha,
...
static void blis_ssymm(char side, char uplo, int m, int n, float alpha, const float* a, int lda,
...
static void blis_dsymm(char side, char uplo, int m, int n, double alpha, const double* a, int lda,
...
static void blis_csymm(char side, char uplo, int m, int n, const fb_complex_float_t* alpha,
                      const fb_complex_float_t* a, int lda, const fb_complex_float_t* b, int ldb,
                      const fb_complex_float_t* beta, fb_complex_float_t* c, int ldc) {
...
static void blis_zsymm(char side, char uplo, int m, int n, const fb_complex_double_t* alpha,
                      const fb_complex_double_t* a, int lda, const fb_complex_double_t* b, int ldb,
                      const fb_complex_double_t* beta, fb_complex_double_t* c, int ldc) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_SIDE, CBLAS_UPLO, int, int, const void*,
                         const void*, int, const void*, int, const void*, void*, int);
...
static void blis_chemm(char side, char uplo, int m, int n, const fb_complex_float_t* alpha,
                      const fb_complex_float_t* a, int lda, const fb_complex_float_t* b, int ldb,
                      const fb_complex_float_t* beta, fb_complex_float_t* c, int ldc) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_SIDE, CBLAS_UPLO, int, int, const void*,
                         const void*, int, const void*, int, const void*, void*, int);
...
static void blis_zhemm(char side, char uplo, int m, int n, const fb_complex_double_t* alpha,
                      const fb_complex_double_t* a, int lda, const fb_complex_double_t* b, int ldb,
                      const fb_complex_double_t* beta, fb_complex_double_t* c, int ldc) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_SIDE, CBLAS_UPLO, int, int, const void*,
                         const void*, int, const void*, int, const void*, void*, int);
...
static void blis_ssyrk(char uplo, char trans, int n, int k, float alpha, const float* a, int lda, float beta, float* c, int ldc) {
...
static void blis_dsyrk(char uplo, char trans, int n, int k, double alpha, const double* a, int lda, double beta, double* c, int ldc) {
...
static void blis_csyrk(char uplo, char trans, int n, int k, const fb_complex_float_t* alpha,
...
static void blis_zsyrk(char uplo, char trans, int n, int k, const fb_complex_double_t* alpha,
...
static void blis_cherk(char uplo, char trans, int n, int k, float alpha, const fb_complex_float_t* a, int lda, float beta, fb_complex_float_t* c, int ldc) {
...
static void blis_zherk(char uplo, char trans, int n, int k, double alpha, const fb_complex_double_t* a, int lda, double beta, fb_complex_double_t* c, int ldc) {
...
static void blis_ssyr2k(char uplo, char trans, int n, int k, float alpha, const float* a, int lda,
                       const float* b, int ldb, float beta, float* c, int ldc) {
...
static void blis_dsyr2k(char uplo, char trans, int n, int k, double alpha, const double* a, int lda,
                       const double* b, int ldb, double beta, double* c, int ldc) {
...
static void blis_csyr2k(char uplo, char trans, int n, int k, const fb_complex_float_t* alpha,
                       const fb_complex_float_t* a, int lda, const fb_complex_float_t* b, int ldb,
                       const fb_complex_float_t* beta, fb_complex_float_t* c, int ldc) {
...
static void blis_zsyr2k(char uplo, char trans, int n, int k, const fb_complex_double_t* alpha,
                       const fb_complex_double_t* a, int lda, const fb_complex_double_t* b, int ldb,
                       const fb_complex_double_t* beta, fb_complex_double_t* c, int ldc) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_UPLO, CBLAS_TRANSPOSE, int, int, const void*, const void*, int, const void*, int, const void*, void*, int);
...
static void blis_cher2k(char uplo, char trans, int n, int k, const fb_complex_float_t* alpha,
                       const fb_complex_float_t* a, int lda, const fb_complex_float_t* b, int ldb,
...
static void blis_zher2k(char uplo, char trans, int n, int k, const fb_complex_double_t* alpha,
                       const fb_complex_double_t* a, int lda, const fb_complex_double_t* b, int ldb,
...
static void blis_strmm(char side, char uplo, char transa, char diag, int m, int n, float alpha, const float* a, int lda, float* b, int ldb) {
...
static void blis_dtrmm(char side, char uplo, char transa, char diag, int m, int n, double alpha, const double* a, int lda, double* b, int ldb) {
...
static void blis_ctrmm(char side, char uplo, char transa, char diag, int m, int n, const fb_complex_float_t* alpha,
...
static void blis_ztrmm(char side, char uplo, char transa, char diag, int m, int n, const fb_complex_double_t* alpha,
...
static void blis_strsm(char side, char uplo, char transa, char diag, int m, int n, float alpha, const float* a, int lda, float* b, int ldb) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_SIDE, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, int, float, const float*, int, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "cblas_strsm");
    if (fn) { fn(CblasColMajor, side_to_cblas(side), uplo_to_cblas(uplo), transpose_to_cblas(transa), diag_to_cblas(diag), m, n, alpha, a, lda, b, ldb); }
}

static void blis_dtrsm(char side, char uplo, char transa, char diag, int m, int n, double alpha, const double* a, int lda, double* b, int ldb) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_SIDE, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, int, double, const double*, int, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "cblas_dtrsm");
    if (fn) { fn(CblasColMajor, side_to_cblas(side), uplo_to_cblas(uplo), transpose_to_cblas(transa), diag_to_cblas(diag), m, n, alpha, a, lda, b, ldb); }
}

static void blis_ctrsm(char side, char uplo, char transa, char diag, int m, int n, const fb_complex_float_t* alpha,
                      const fb_complex_float_t* a, int lda, fb_complex_float_t* b, int ldb) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_SIDE, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, int, const void*, const void*, int, void*, int);
...
static void blis_ztrsm(char side, char uplo, char transa, char diag, int m, int n, const fb_complex_double_t* alpha,
                      const fb_complex_double_t* a, int lda, fb_complex_double_t* b, int ldb) {
    typedef void (*fn_t)(CBLAS_LAYOUT, CBLAS_SIDE, CBLAS_UPLO, CBLAS_TRANSPOSE, CBLAS_DIAG, int, int, const void*, const void*, int, void*, int);
...
static int blis_sgesv(int n, int nrhs, float* a, int lda, int* ipiv, float* b, int ldb) {
    typedef int (*fn_t)(int, int, int, float*, int, int*, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_sgesv");
    return fn ? fn(102, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

static int blis_dgesv(int n, int nrhs, double* a, int lda, int* ipiv, double* b, int ldb) {
    typedef int (*fn_t)(int, int, int, double*, int, int*, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_dgesv");
    return fn ? fn(102, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

static int blis_cgesv(int n, int nrhs, fb_complex_float_t* a, int lda, int* ipiv, fb_complex_float_t* b, int ldb) {
    typedef int (*fn_t)(int, int, int, fb_complex_float_t*, int, int*, fb_complex_float_t*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_cgesv");
    return fn ? fn(102, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

static int blis_zgesv(int n, int nrhs, fb_complex_double_t* a, int lda, int* ipiv, fb_complex_double_t* b, int ldb) {
    typedef int (*fn_t)(int, int, int, fb_complex_double_t*, int, int*, fb_complex_double_t*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_zgesv");
    return fn ? fn(102, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

/* LAPACK - LU factorization (GETRF) */
static int blis_sgetrf(int m, int n, float* a, int lda, int* ipiv) {
    typedef int (*fn_t)(int, int, int, float*, int, int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_sgetrf");
    return fn ? fn(102, m, n, a, lda, ipiv) : -1;
}

static int blis_dgetrf(int m, int n, double* a, int lda, int* ipiv) {
    typedef int (*fn_t)(int, int, int, double*, int, int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_dgetrf");
    return fn ? fn(102, m, n, a, lda, ipiv) : -1;
}

static int blis_cgetrf(int m, int n, fb_complex_float_t* a, int lda, int* ipiv) {
    typedef int (*fn_t)(int, int, int, fb_complex_float_t*, int, int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_cgetrf");
    return fn ? fn(102, m, n, a, lda, ipiv) : -1;
}

static int blis_zgetrf(int m, int n, fb_complex_double_t* a, int lda, int* ipiv) {
    typedef int (*fn_t)(int, int, int, fb_complex_double_t*, int, int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_zgetrf");
    return fn ? fn(102, m, n, a, lda, ipiv) : -1;
}

/* LAPACK - Solve with LU factorization (GETRS) */
static int blis_sgetrs(char trans, int n, int nrhs, const float* a, int lda, const int* ipiv, float* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const float*, int, const int*, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_sgetrs");
    return fn ? fn(102, trans, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

static int blis_dgetrs(char trans, int n, int nrhs, const double* a, int lda, const int* ipiv, double* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const double*, int, const int*, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_dgetrs");
    return fn ? fn(102, trans, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

static int blis_cgetrs(char trans, int n, int nrhs, const fb_complex_float_t* a, int lda, const int* ipiv, fb_complex_float_t* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const fb_complex_float_t*, int, const int*, fb_complex_float_t*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_cgetrs");
    return fn ? fn(102, trans, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

static int blis_zgetrs(char trans, int n, int nrhs, const fb_complex_double_t* a, int lda, const int* ipiv, fb_complex_double_t* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const fb_complex_double_t*, int, const int*, fb_complex_double_t*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_zgetrs");
    return fn ? fn(102, trans, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

/* LAPACK - Matrix inverse (GETRI) */
static int blis_sgetri(int n, float* a, int lda, const int* ipiv) {
    typedef int (*fn_t)(int, int, float*, int, const int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_sgetri");
    return fn ? fn(102, n, a, lda, ipiv) : -1;
}

static int blis_dgetri(int n, double* a, int lda, const int* ipiv) {
    typedef int (*fn_t)(int, int, double*, int, const int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_dgetri");
    return fn ? fn(102, n, a, lda, ipiv) : -1;
}

static int blis_cgetri(int n, fb_complex_float_t* a, int lda, const int* ipiv) {
    typedef int (*fn_t)(int, int, fb_complex_float_t*, int, const int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_cgetri");
    return fn ? fn(102, n, a, lda, ipiv) : -1;
}

static int blis_zgetri(int n, fb_complex_double_t* a, int lda, const int* ipiv) {
    typedef int (*fn_t)(int, int, fb_complex_double_t*, int, const int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_zgetri");
    return fn ? fn(102, n, a, lda, ipiv) : -1;
}

/* LAPACK - Cholesky solve (POSV) */
static int blis_sposv(char uplo, int n, int nrhs, float* a, int lda, float* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, float*, int, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_sposv");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

static int blis_dposv(char uplo, int n, int nrhs, double* a, int lda, double* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, double*, int, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_dposv");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

static int blis_cposv(char uplo, int n, int nrhs, fb_complex_float_t* a, int lda, fb_complex_float_t* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, fb_complex_float_t*, int, fb_complex_float_t*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_cposv");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

static int blis_zposv(char uplo, int n, int nrhs, fb_complex_double_t* a, int lda, fb_complex_double_t* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, fb_complex_double_t*, int, fb_complex_double_t*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_zposv");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

/* LAPACK - Cholesky factorization (POTRF) */
static int blis_spotrf(char uplo, int n, float* a, int lda) {
    typedef int (*fn_t)(int, char, int, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_spotrf");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

static int blis_dpotrf(char uplo, int n, double* a, int lda) {
    typedef int (*fn_t)(int, char, int, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_dpotrf");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

static int blis_cpotrf(char uplo, int n, fb_complex_float_t* a, int lda) {
    typedef int (*fn_t)(int, char, int, fb_complex_float_t*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_cpotrf");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

static int blis_zpotrf(char uplo, int n, fb_complex_double_t* a, int lda) {
    typedef int (*fn_t)(int, char, int, fb_complex_double_t*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_zpotrf");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

/* LAPACK - Solve with Cholesky factorization (POTRS) */
static int blis_spotrs(char uplo, int n, int nrhs, const float* a, int lda, float* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const float*, int, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_spotrs");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

static int blis_dpotrs(char uplo, int n, int nrhs, const double* a, int lda, double* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const double*, int, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_dpotrs");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

static int blis_cpotrs(char uplo, int n, int nrhs, const fb_complex_float_t* a, int lda, fb_complex_float_t* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const fb_complex_float_t*, int, fb_complex_float_t*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_cpotrs");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

static int blis_zpotrs(char uplo, int n, int nrhs, const fb_complex_double_t* a, int lda, fb_complex_double_t* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const fb_complex_double_t*, int, fb_complex_double_t*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_zpotrs");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

/* LAPACK - Cholesky inverse (POTRI) */
static int blis_spotri(char uplo, int n, float* a, int lda) {
    typedef int (*fn_t)(int, char, int, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_spotri");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

static int blis_dpotri(char uplo, int n, double* a, int lda) {
    typedef int (*fn_t)(int, char, int, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_dpotri");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

static int blis_cpotri(char uplo, int n, fb_complex_float_t* a, int lda) {
    typedef int (*fn_t)(int, char, int, fb_complex_float_t*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_cpotri");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

static int blis_zpotri(char uplo, int n, fb_complex_double_t* a, int lda) {
    typedef int (*fn_t)(int, char, int, fb_complex_double_t*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_zpotri");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

/* LAPACK - QR factorization (GEQRF) */
static int blis_sgeqrf(int m, int n, float* a, int lda, float* tau) {
    typedef int (*fn_t)(int, int, int, float*, int, float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_sgeqrf");
    return fn ? fn(102, m, n, a, lda, tau) : -1;
}

static int blis_dgeqrf(int m, int n, double* a, int lda, double* tau) {
    typedef int (*fn_t)(int, int, int, double*, int, double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_dgeqrf");
    return fn ? fn(102, m, n, a, lda, tau) : -1;
}

static int blis_cgeqrf(int m, int n, fb_complex_float_t* a, int lda, fb_complex_float_t* tau) {
    typedef int (*fn_t)(int, int, int, fb_complex_float_t*, int, fb_complex_float_t*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_cgeqrf");
    return fn ? fn(102, m, n, a, lda, tau) : -1;
}

static int blis_zgeqrf(int m, int n, fb_complex_double_t* a, int lda, fb_complex_double_t* tau) {
    typedef int (*fn_t)(int, int, int, fb_complex_double_t*, int, fb_complex_double_t*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_zgeqrf");
    return fn ? fn(102, m, n, a, lda, tau) : -1;
}

/* LAPACK - Generate Q from QR (ORGQR/UNGQR) */
static int blis_sorgqr(int m, int n, int k, float* a, int lda, const float* tau) {
    typedef int (*fn_t)(int, int, int, int, float*, int, const float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_sorgqr");
    return fn ? fn(102, m, n, k, a, lda, tau) : -1;
}

static int blis_dorgqr(int m, int n, int k, double* a, int lda, const double* tau) {
    typedef int (*fn_t)(int, int, int, int, double*, int, const double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_dorgqr");
    return fn ? fn(102, m, n, k, a, lda, tau) : -1;
}

static int blis_cungqr(int m, int n, int k, fb_complex_float_t* a, int lda, const fb_complex_float_t* tau) {
    typedef int (*fn_t)(int, int, int, int, fb_complex_float_t*, int, const fb_complex_float_t*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_cungqr");
    return fn ? fn(102, m, n, k, a, lda, tau) : -1;
}

static int blis_zungqr(int m, int n, int k, fb_complex_double_t* a, int lda, const fb_complex_double_t* tau) {
    typedef int (*fn_t)(int, int, int, int, fb_complex_double_t*, int, const fb_complex_double_t*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_zungqr");
    return fn ? fn(102, m, n, k, a, lda, tau) : -1;
}

/* LAPACK - SVD (GESVD) */
static int blis_sgesvd(char jobu, char jobvt, int m, int n, float* a, int lda, float* s, float* u, int ldu, float* vt, int ldvt, float* superb) {
    typedef int (*fn_t)(int, char, char, int, int, float*, int, float*, float*, int, float*, int, float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_sgesvd");
    return fn ? fn(102, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt, superb) : -1;
}

static int blis_dgesvd(char jobu, char jobvt, int m, int n, double* a, int lda, double* s, double* u, int ldu, double* vt, int ldvt, double* superb) {
    typedef int (*fn_t)(int, char, char, int, int, double*, int, double*, double*, int, double*, int, double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_dgesvd");
    return fn ? fn(102, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt, superb) : -1;
}

static int blis_cgesvd(char jobu, char jobvt, int m, int n, fb_complex_float_t* a, int lda, float* s,
    ...
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_cgesvd");
    return fn ? fn(102, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt, superb) : -1;
}

static int blis_zgesvd(char jobu, char jobvt, int m, int n, fb_complex_double_t* a, int lda, double* s,
    ...
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_zgesvd");
    return fn ? fn(102, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt, superb) : -1;
}

/* LAPACK - Eigenvalues (SYEV/HEEV) */
static int blis_ssyev(char jobz, char uplo, int n, float* a, int lda, float* w) {
    typedef int (*fn_t)(int, char, char, int, float*, int, float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_ssyev");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}

static int blis_dsyev(char jobz, char uplo, int n, double* a, int lda, double* w) {
    typedef int (*fn_t)(int, char, char, int, double*, int, double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_dsyev");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}

static int blis_cheev(char jobz, char uplo, int n, fb_complex_float_t* a, int lda, float* w) {
    typedef int (*fn_t)(int, char, char, int, fb_complex_float_t*, int, float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_cheev");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}

static int blis_zheev(char jobz, char uplo, int n, fb_complex_double_t* a, int lda, double* w) {
    typedef int (*fn_t)(int, char, char, int, fb_complex_double_t*, int, double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_zheev");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}

/* LAPACK - Eigenvalues divide-and-conquer (SYEVD/HEEVD) */
static int blis_ssyevd(char jobz, char uplo, int n, float* a, int lda, float* w) {
    typedef int (*fn_t)(int, char, char, int, float*, int, float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_ssyevd");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}

static int blis_dsyevd(char jobz, char uplo, int n, double* a, int lda, double* w) {
    typedef int (*fn_t)(int, char, char, int, double*, int, double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_dsyevd");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}

static int blis_cheevd(char jobz, char uplo, int n, fb_complex_float_t* a, int lda, float* w) {
    typedef int (*fn_t)(int, char, char, int, fb_complex_float_t*, int, float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_cheevd");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}

static int blis_zheevd(char jobz, char uplo, int n, fb_complex_double_t* a, int lda, double* w) {
    typedef int (*fn_t)(int, char, char, int, fb_complex_double_t*, int, double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_blis.handle, "LAPACKE_zheevd");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}
