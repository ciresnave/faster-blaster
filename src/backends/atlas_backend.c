...
static int atlas_sgesv(int n, int nrhs, float* a, int lda, int* ipiv, float* b, int ldb) {
    typedef int (*fn_t)(int, int, int, float*, int, int*, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_sgesv");
    return fn ? fn(102, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

static int atlas_dgesv(int n, int nrhs, double* a, int lda, int* ipiv, double* b, int ldb) {
    typedef int (*fn_t)(int, int, int, double*, int, int*, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_dgesv");
    return fn ? fn(102, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

static int atlas_cgesv(int n, int nrhs, fb_complex_float* a, int lda, int* ipiv, fb_complex_float* b, int ldb) {
    typedef int (*fn_t)(int, int, int, fb_complex_float*, int, int*, fb_complex_float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_cgesv");
    return fn ? fn(102, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

static int atlas_zgesv(int n, int nrhs, fb_complex_double* a, int lda, int* ipiv, fb_complex_double* b, int ldb) {
    typedef int (*fn_t)(int, int, int, fb_complex_double*, int, int*, fb_complex_double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_zgesv");
    return fn ? fn(102, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

/* LAPACK - LU factorization (GETRF) */
static int atlas_sgetrf(int m, int n, float* a, int lda, int* ipiv) {
    typedef int (*fn_t)(int, int, int, float*, int, int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_sgetrf");
    return fn ? fn(102, m, n, a, lda, ipiv) : -1;
}

static int atlas_dgetrf(int m, int n, double* a, int lda, int* ipiv) {
    typedef int (*fn_t)(int, int, int, double*, int, int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_dgetrf");
    return fn ? fn(102, m, n, a, lda, ipiv) : -1;
}

static int atlas_cgetrf(int m, int n, fb_complex_float* a, int lda, int* ipiv) {
    typedef int (*fn_t)(int, int, int, fb_complex_float*, int, int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_cgetrf");
    return fn ? fn(102, m, n, a, lda, ipiv) : -1;
}

static int atlas_zgetrf(int m, int n, fb_complex_double* a, int lda, int* ipiv) {
    typedef int (*fn_t)(int, int, int, fb_complex_double*, int, int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_zgetrf");
    return fn ? fn(102, m, n, a, lda, ipiv) : -1;
}

/* LAPACK - Solve with LU factorization (GETRS) */
static int atlas_sgetrs(char trans, int n, int nrhs, const float* a, int lda, const int* ipiv, float* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const float*, int, const int*, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_sgetrs");
    return fn ? fn(102, trans, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

static int atlas_dgetrs(char trans, int n, int nrhs, const double* a, int lda, const int* ipiv, double* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const double*, int, const int*, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_dgetrs");
    return fn ? fn(102, trans, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

static int atlas_cgetrs(char trans, int n, int nrhs, const fb_complex_float* a, int lda, const int* ipiv, fb_complex_float* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const fb_complex_float*, int, const int*, fb_complex_float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_cgetrs");
    return fn ? fn(102, trans, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

static int atlas_zgetrs(char trans, int n, int nrhs, const fb_complex_double* a, int lda, const int* ipiv, fb_complex_double* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const fb_complex_double*, int, const int*, fb_complex_double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_zgetrs");
    return fn ? fn(102, trans, n, nrhs, a, lda, ipiv, b, ldb) : -1;
}

/* LAPACK - Matrix inverse (GETRI) */
static int atlas_sgetri(int n, float* a, int lda, const int* ipiv) {
    typedef int (*fn_t)(int, int, float*, int, const int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_sgetri");
    return fn ? fn(102, n, a, lda, ipiv) : -1;
}

static int atlas_dgetri(int n, double* a, int lda, const int* ipiv) {
    typedef int (*fn_t)(int, int, double*, int, const int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_dgetri");
    return fn ? fn(102, n, a, lda, ipiv) : -1;
}

static int atlas_cgetri(int n, fb_complex_float* a, int lda, const int* ipiv) {
    typedef int (*fn_t)(int, int, fb_complex_float*, int, const int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_cgetri");
    return fn ? fn(102, n, a, lda, ipiv) : -1;
}

static int atlas_zgetri(int n, fb_complex_double* a, int lda, const int* ipiv) {
    typedef int (*fn_t)(int, int, fb_complex_double*, int, const int*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_zgetri");
    return fn ? fn(102, n, a, lda, ipiv) : -1;
}

/* LAPACK - Cholesky solve (POSV) */
static int atlas_sposv(char uplo, int n, int nrhs, float* a, int lda, float* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, float*, int, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_sposv");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

static int atlas_dposv(char uplo, int n, int nrhs, double* a, int lda, double* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, double*, int, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_dposv");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

static int atlas_cposv(char uplo, int n, int nrhs, fb_complex_float* a, int lda, fb_complex_float* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, fb_complex_float*, int, fb_complex_float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_cposv");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

static int atlas_zposv(char uplo, int n, int nrhs, fb_complex_double* a, int lda, fb_complex_double* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, fb_complex_double*, int, fb_complex_double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_zposv");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

/* LAPACK - Cholesky factorization (POTRF) */
static int atlas_spotrf(char uplo, int n, float* a, int lda) {
    typedef int (*fn_t)(int, char, int, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_spotrf");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

static int atlas_dpotrf(char uplo, int n, double* a, int lda) {
    typedef int (*fn_t)(int, char, int, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_dpotrf");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

static int atlas_cpotrf(char uplo, int n, fb_complex_float* a, int lda) {
    typedef int (*fn_t)(int, char, int, fb_complex_float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_cpotrf");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

static int atlas_zpotrf(char uplo, int n, fb_complex_double* a, int lda) {
    typedef int (*fn_t)(int, char, int, fb_complex_double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_zpotrf");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

/* LAPACK - Solve with Cholesky factorization (POTRS) */
static int atlas_spotrs(char uplo, int n, int nrhs, const float* a, int lda, float* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const float*, int, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_spotrs");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

static int atlas_dpotrs(char uplo, int n, int nrhs, const double* a, int lda, double* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const double*, int, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_dpotrs");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

static int atlas_cpotrs(char uplo, int n, int nrhs, const fb_complex_float* a, int lda, fb_complex_float* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const fb_complex_float*, int, fb_complex_float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_cpotrs");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

static int atlas_zpotrs(char uplo, int n, int nrhs, const fb_complex_double* a, int lda, fb_complex_double* b, int ldb) {
    typedef int (*fn_t)(int, char, int, int, const fb_complex_double*, int, fb_complex_double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_zpotrs");
    return fn ? fn(102, uplo, n, nrhs, a, lda, b, ldb) : -1;
}

/* LAPACK - Cholesky inverse (POTRI) */
static int atlas_spotri(char uplo, int n, float* a, int lda) {
    typedef int (*fn_t)(int, char, int, float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_spotri");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

static int atlas_dpotri(char uplo, int n, double* a, int lda) {
    typedef int (*fn_t)(int, char, int, double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_dpotri");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

static int atlas_cpotri(char uplo, int n, fb_complex_float* a, int lda) {
    typedef int (*fn_t)(int, char, int, fb_complex_float*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_cpotri");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

static int atlas_zpotri(char uplo, int n, fb_complex_double* a, int lda) {
    typedef int (*fn_t)(int, char, int, fb_complex_double*, int);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_zpotri");
    return fn ? fn(102, uplo, n, a, lda) : -1;
}

/* LAPACK - QR factorization (GEQRF) */
static int atlas_sgeqrf(int m, int n, float* a, int lda, float* tau) {
    typedef int (*fn_t)(int, int, int, float*, int, float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_sgeqrf");
    return fn ? fn(102, m, n, a, lda, tau) : -1;
}

static int atlas_dgeqrf(int m, int n, double* a, int lda, double* tau) {
    typedef int (*fn_t)(int, int, int, double*, int, double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_dgeqrf");
    return fn ? fn(102, m, n, a, lda, tau) : -1;
}

static int atlas_cgeqrf(int m, int n, fb_complex_float* a, int lda, fb_complex_float* tau) {
    typedef int (*fn_t)(int, int, int, fb_complex_float*, int, fb_complex_float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_cgeqrf");
    return fn ? fn(102, m, n, a, lda, tau) : -1;
}

static int atlas_zgeqrf(int m, int n, fb_complex_double* a, int lda, fb_complex_double* tau) {
    typedef int (*fn_t)(int, int, int, fb_complex_double*, int, fb_complex_double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_zgeqrf");
    return fn ? fn(102, m, n, a, lda, tau) : -1;
}

/* LAPACK - Generate Q from QR (ORGQR/UNGQR) */
static int atlas_sorgqr(int m, int n, int k, float* a, int lda, const float* tau) {
    typedef int (*fn_t)(int, int, int, int, float*, int, const float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_sorgqr");
    return fn ? fn(102, m, n, k, a, lda, tau) : -1;
}

static int atlas_dorgqr(int m, int n, int k, double* a, int lda, const double* tau) {
    typedef int (*fn_t)(int, int, int, int, double*, int, const double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_dorgqr");
    return fn ? fn(102, m, n, k, a, lda, tau) : -1;
}

static int atlas_cungqr(int m, int n, int k, fb_complex_float* a, int lda, const fb_complex_float* tau) {
    typedef int (*fn_t)(int, int, int, int, fb_complex_float*, int, const fb_complex_float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_cungqr");
    return fn ? fn(102, m, n, k, a, lda, tau) : -1;
}

static int atlas_zungqr(int m, int n, int k, fb_complex_double* a, int lda, const fb_complex_double* tau) {
    typedef int (*fn_t)(int, int, int, int, fb_complex_double*, int, const fb_complex_double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_zungqr");
    return fn ? fn(102, m, n, k, a, lda, tau) : -1;
}

/* LAPACK - SVD (GESVD) */
static int atlas_sgesvd(char jobu, char jobvt, int m, int n, float* a, int lda, float* s, float* u, int ldu, float* vt, int ldvt, float* superb) {
    typedef int (*fn_t)(int, char, char, int, int, float*, int, float*, float*, int, float*, int, float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_sgesvd");
    return fn ? fn(102, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt, superb) : -1;
}

static int atlas_dgesvd(char jobu, char jobvt, int m, int n, double* a, int lda, double* s, double* u, int ldu, double* vt, int ldvt, double* superb) {
    typedef int (*fn_t)(int, char, char, int, int, double*, int, double*, double*, int, double*, int, double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_dgesvd");
    return fn ? fn(102, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt, superb) : -1;
}

static int atlas_cgesvd(char jobu, char jobvt, int m, int n, fb_complex_float* a, int lda, float* s,
    ...
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_cgesvd");
    return fn ? fn(102, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt, superb) : -1;
}

static int atlas_zgesvd(char jobu, char jobvt, int m, int n, fb_complex_double* a, int lda, double* s,
    ...
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_zgesvd");
    return fn ? fn(102, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt, superb) : -1;
}

/* LAPACK - Eigenvalues (SYEV/HEEV) */
static int atlas_ssyev(char jobz, char uplo, int n, float* a, int lda, float* w) {
    typedef int (*fn_t)(int, char, char, int, float*, int, float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_ssyev");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}

static int atlas_dsyev(char jobz, char uplo, int n, double* a, int lda, double* w) {
    typedef int (*fn_t)(int, char, char, int, double*, int, double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_dsyev");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}

static int atlas_cheev(char jobz, char uplo, int n, fb_complex_float* a, int lda, float* w) {
    typedef int (*fn_t)(int, char, char, int, fb_complex_float*, int, float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_cheev");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}

static int atlas_zheev(char jobz, char uplo, int n, fb_complex_double* a, int lda, double* w) {
    typedef int (*fn_t)(int, char, char, int, fb_complex_double*, int, double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_zheev");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}

/* LAPACK - Eigenvalues divide-and-conquer (SYEVD/HEEVD) */
static int atlas_ssyevd(char jobz, char uplo, int n, float* a, int lda, float* w) {
    typedef int (*fn_t)(int, char, char, int, float*, int, float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_ssyevd");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}

static int atlas_dsyevd(char jobz, char uplo, int n, double* a, int lda, double* w) {
    typedef int (*fn_t)(int, char, char, int, double*, int, double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_dsyevd");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}

static int atlas_cheevd(char jobz, char uplo, int n, fb_complex_float* a, int lda, float* w) {
    typedef int (*fn_t)(int, char, char, int, fb_complex_float*, int, float*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_cheevd");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}

static int atlas_zheevd(char jobz, char uplo, int n, fb_complex_double* a, int lda, double* w) {
    typedef int (*fn_t)(int, char, char, int, fb_complex_double*, int, double*);
    fn_t fn = (fn_t)FB_LOAD_SYMBOL(g_atlas.handle, "LAPACKE_zheevd");
    return fn ? fn(102, jobz, uplo, n, a, lda, w) : -1;
}
