/* sgeev3 - Eigenvalues and eigenvectors via QR with aggressive early deflation */
#
void sgeev3_(char* jobvl, char* jobvr, int* n, float* a, int* lda, float* wr, float* wi, float* vl, int* ldvl, float* vr, int* ldvr, float* work, int* lwork, int* info) {
