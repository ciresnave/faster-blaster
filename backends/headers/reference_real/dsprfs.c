...
/* Double precision packed symmetric refinement */
void dsprfs_(const char *uplo, const int *n, const int *nrhs, const double *ap,
              const double *afp, const int *ipiv, const double *B, const int *ldb,
