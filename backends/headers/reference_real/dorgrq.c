...
/**
 * DORGRQ - Generate m-by-n matrix Q with orthonormal rows from RQ factorization
 * 
 * Generates m-by-n orthogonal matrix Q from RQ factorization via DGERQF.
 ...
 *   A     : RQ factorization from DGERQF (input/output)
 *   lda   : Leading dimension of A
 *   tau   : Scalar factors from DGERQF
 *   work  : Workspace
 *   lwork : Size of workspace
 *   info  : Status (0=success, <0=invalid param)
 */
void dorgrq_(const int *m, const int *n, const int *k, double *A, const int *lda,
