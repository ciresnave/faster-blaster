...
/* Solve tridiagonal system using LU factorization from SGTTRF */
void sgttrs_(const char *trans, const int *n, const int *nrhs, float *dl,
              float *d, float *du, float *du2, const int *ipiv,
