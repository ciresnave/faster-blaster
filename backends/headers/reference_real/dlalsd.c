/* dlalsd - SVD via bisection and QR */
#
void dlalsd_(char* uplo, int* smlsiz, int* n, int* nrhs, double* d, double* e, double* b, int* ldb, double* rcond, int* rank, double* work, int* lwork, int* iwork, int* info) {
