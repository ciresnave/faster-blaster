...
/* Symmetric packed refinement */
void sprfs_(const char *uplo, const int *n, const int *nrhs, const float *ap,
             const float *afp, const int *ipiv, const float *B, const int *ldb,
