/* dgeev2 - Eigenvalues and eigenvectors via explicit shift QR */
#
void dgeev2_(char* jobvl, char* jobvr, int* n, double* a, int* lda, double* wr, double* wi, double* vl, int* ldvl, double* vr, int* ldvr, double* work, int* lwork, int* info) {
