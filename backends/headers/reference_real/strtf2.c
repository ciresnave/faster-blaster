/* strtf2 - Triangular factorization (level 2 unblocked version) */

#

/* STRTF2 - Compute RFP format representation of triangular matrix
   ...
   INFO: Status
 */
void strtf2_(const char *transr, const char *uplo, const char *diag,
